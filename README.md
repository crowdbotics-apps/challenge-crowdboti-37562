...
## Project Structure
    ...
    ├── challenge_crowdboti_37562  # Django project configurations
...
1. Clone this repo and `cd challenge_crowdboti_37562`
...
2. Clone this repo and `cd challenge_crowdboti_37562`
